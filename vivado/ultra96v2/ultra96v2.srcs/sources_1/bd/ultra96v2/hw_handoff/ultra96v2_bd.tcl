...
proc create_root_design { parentCell } {
  ...
  set can_phy_rx_0 [ create_bd_port -dir I can_phy_rx_0 ]
  set can_phy_tx_0 [ create_bd_port -dir O can_phy_tx_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU__CRL_APB__CAN0_REF_CTRL__ACT_FREQMHZ {99.999999} \
  ...
  connect_bd_net -net can_phy_rx_0_1 [get_bd_ports can_phy_rx_0] [get_bd_pins zynq_ultra_ps_e_0/emio_can0_phy_rx]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_emio_can0_phy_tx [get_bd_ports can_phy_tx_0] [get_bd_pins zynq_ultra_ps_e_0/emio_can0_phy_tx]
  connect_bd_net -net zynq_ultra_ps_e_0_emio_uart0_rtsn [get_bd_ports BT_rtsn] [get_bd_pins zynq_ultra_ps_e_0/emio_uart0_rtsn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  ...
  set_property PFM_NAME {keitetsu:ultra96v2:ultra96v2:1.0} [get_files [current_bd_design].bd]
  set_property PFM.CLOCK {clk_out1 {id "1" is_default "false" proc_sys_reset "/proc_sys_reset_0"} clk_out2 {id "2" is_default "true" proc_sys_reset "/proc_sys_reset_1"} clk_out3 {id "3" is_default "false" proc_sys_reset "/proc_sys_reset_2"} clk_out4 {id "4" is_default "false" proc_sys_reset "/proc_sys_reset_3"} clk_out5 {id "5" is_default "false" proc_sys_reset "/proc_sys_reset_4"} clk_out6 {id "6" is_default "false" proc_sys_reset "/proc_sys_reset_5"} clk_out7 {id "7" is_default "false" proc_sys_reset "/proc_sys_reset_6"}} [get_bd_cells /clk_wiz_0]
